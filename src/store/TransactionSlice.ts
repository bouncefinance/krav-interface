...
export enum TransactionState {
  ...
  STAKE_KRAV = 'stake Bounce Quanto',
  WITHDRAW_KRAV = 'withdraw Bounce Quanto',
  CLAIM_KRAV_REWARD = 'claim Bounce Quanto reward',
  UPDATE_SL_ORDER = 'Update stop loss...',
  UPDATE_TP_ORDER = 'Update take profit...',
  LOCK_KRAV = 'Locking Bounce Quanto...',
...
export enum TransactionAction {
  ...
  CLAIM_LP_REWARD = 'Claim lp reward',
  FAUCET_TEST_TOKEN = 'Faucet token',
  STAKE_KRAV = 'Staked Bounce Quanto',
  WITHDRAW_KRAV = 'Withdraw Bounce Quanto',
  CLAIM_KRAV_REWARD = 'claim Bounce Quanto reward',
  LOCK_KRAV = 'Locked Bounce Quanto',
  INCREASE_AMOUNT = 'Increase locked Bounce Quanto amount',
