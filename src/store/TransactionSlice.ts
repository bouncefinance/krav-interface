...
export enum TransactionState {
  ...
  STAKE_KRAV = 'stake Bounce',
  WITHDRAW_KRAV = 'withdraw Bounce',
  CLAIM_KRAV_REWARD = 'claim Bounce reward',
  UPDATE_SL_ORDER = 'Update stop loss...',
  UPDATE_TP_ORDER = 'Update take profit...',
  LOCK_KRAV = 'Locking Bounce...',
...
export enum TransactionAction {
  ...
  CLAIM_LP_REWARD = 'Claim lp reward',
  FAUCET_TEST_TOKEN = 'Faucet token',
  STAKE_KRAV = 'Staked Bounce',
  WITHDRAW_KRAV = 'Withdraw Bounce',
  CLAIM_KRAV_REWARD = 'claim Bounce reward',
  LOCK_KRAV = 'Locked Bounce',
  INCREASE_AMOUNT = 'Increase locked Bounce amount',
