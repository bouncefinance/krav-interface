...
const TARGET_POOL_TRADING = ['0x7b94A53BAC55ED44746CA1D53ee2C952D937D689', '0x035D8BdcA71412486cef8DEcD386677c98eEC261']
  ...
  return useCallback(
    async (localChainId?: number) => {
      try {
        ...
        forMatter = forMatter.filter((pool) => TARGET_POOL_TRADING.includes(pool.tradingT))
